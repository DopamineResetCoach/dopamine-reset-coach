...
$vk_alt = esc_attr__( 'Een groot zeeschip vaart vlak langs de kust, gezien vanaf het terras van Strandpaviljoen Valkenisse', 'valkenisse' );
?>
<!-- wp:cover {"url":"<?php echo $vk_img; ?>","alt":"<?php echo $vk_alt; ?>","dimRatio":0,"minHeight":88,"minHeightUnit":"vh","contentPosition":"bottom left","align":"full","className":"vk-view"} -->
<div class="wp-block-cover alignfull has-custom-content-position is-position-bottom-left vk-view" style="min-height:88vh"><img class="wp-block-cover__image-background" alt="<?php echo $vk_alt; ?>" src="<?php echo $vk_img; ?>" data-object-fit="cover"/><span aria-hidden="true" class="wp-block-cover__background has-background-dim-0 has-background-dim"></span><div class="wp-block-cover__inner-container"><!-- wp:group {"className":"vk-view__content vk-reveal","layout":{"type":"constrained","contentSize":"640px","justifyContent":"left"}} -->
